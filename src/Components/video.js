...
const Video = (props) => { 
  ...
  return ( 
    ...
    <div className="Component"> 
			...
			<div>
				{/* <button onClick={handleSubmissioni}>Submit</button> */}
			</div></div>
		<div className="main_box">
	<div className="img-box" id="img_box_0">
 
 <div className="img-prevv" id="img_impv_0">
 ...
 <div className="middle-butt" id="img_mid_0" style={{top:{top}}}>

 &nbsp;<label id="img_upts_0" className="btn btn-primary">
                {video}
                <input type="file" name="file" accept="video/*" style={{ display: 'none' }} className="test" onChange={imageChange} />
 ...
 &nbsp;
	 ...
	 <button type="button" id="img_mgia_0" className="btn btn-primary">Merge Video+Audio</button>
	 
    
	 {selectedImage && (
         <p >Video: {selectedImage.name}</p>
        )}&nbsp;
		 {selectedText && (
...
{/* <button type="button" id="add_more_img" className="btn btn-success">Add More Image</button> */}
<hr />
</div>
</Row>
    </Container>
